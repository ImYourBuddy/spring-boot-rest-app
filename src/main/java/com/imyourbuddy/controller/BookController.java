...
public class BookController {
    ...
    @PutMapping("/books/{id}")
    public void updateBookById(@PathVariable(value = "id") int id, @RequestBody Book book) {
        service.updateBookById(id, book.getName(), book.getPrice(), book.getWarehouse(), book.getQuantity());
    }
}
